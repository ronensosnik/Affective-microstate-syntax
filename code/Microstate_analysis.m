...
Meds_Sensitivity_tests = 1;

Find_microstates = 0;
Compute_and_save_metrics = 0;
Analyze_metrics_only_age_as_covariate = 0;
Analyze_transitions_only_age_as_covariate = 0;
Link_trial_RT = 0;
...
if ~Pipeline_Sensitivity_tests
    ...
    saveDir = 'D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Sensitivity tests\Alternative pipelines\GFP_Peaks only\';
...
if Compute_and_save_metrics
    ...
    if ~Pipeline_Sensitivity_tests
        ...
        save('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Sensitivity tests\Alternative pipelines\GFP_Peaks only\Metrics_ALL','ALL_Mean')
    end
end
...
if Analyze_metrics_only_age_as_covariate
    ...
    if ~Pipeline_Sensitivity_tests
        load('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Metrics_ALL.mat');
    else
        load('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Sensitivity tests\Alternative pipelines\GFP_Peaks only\Metrics_ALL.mat');
    end
...
if Meds_Sensitivity_tests
    ...
    save('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Duration_Baseline_vs_meds.mat', 'Duration_Baseline_vs_meds');
    save('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Occurrence_Baseline_vs_meds.mat', 'Occurrence_Baseline_vs_meds');
    save('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Coverage_Baseline_vs_meds.mat', 'Coverage_Baseline_vs_meds');

    save('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Duration_Baseline_vs_meds_poly.mat', 'Duration_Baseline_vs_meds_poly');
    save('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Occurrence_Baseline_vs_meds_poly.mat', 'Occurrence_Baseline_vs_meds_poly');
    save('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Coverage_Baseline_vs_meds_poly.mat', 'Coverage_Baseline_vs_meds_poly');
    ...
    save('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Sensitivity tests\Including_meds_as_covariates\Transitions\Q1\TransStats_Q1_MedsClasses_FDR.mat', 'TransStats_cellFDR_classes');
    ...
    save('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Sensitivity tests\Including_meds_as_covariates\Transitions\Q1\TransStats_Q1_MedsPoly_FDR.mat', 'TransStats_cellFDR_poly');
    ...
    xlsx_q1 = fullfile('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Sensitivity tests\Including_meds_as_covariates\Transitions\Q1\', 'Q1_Meds_Robustness.xlsx');
    ...
    save('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Sensitivity tests\Including_meds_as_covariates\Transitions\Q2\CompStats_Q2_Baseline_FDR.mat', 'CompStats_Q2');
    ...
    save('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Sensitivity tests\Including_meds_as_covariates\Transitions\Q2\CompStats_Q2_MedsClasses_FDR.mat', 'CompStats_Q2_classes');
    ...
    save('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Sensitivity tests\Including_meds_as_covariates\Transitions\Q2\CompStats_Q2_MedsPoly_FDR.mat', 'CompStats_Q2_poly');
    ...
    for spec = ["classes", "poly"]
        ...
        outT = [confirm2; Rctl];
        out_csv = fullfile('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Sensitivity tests\Including_meds_as_covariates\Transitions\Q3', sprintf('rt_trial_confirmatory2_meds_%s.csv', char(spec)));
        writetable(outT, out_csv);

        % Optional: make a forest figure from this CSV

        try
            out_fig = fullfile('D:\Papers\2025\In preparation\XXX (task microstates)\Analysis\Sensitivity tests\Including_meds_as_covariates\Transitions\Q3', sprintf('Fig_RT_Confirmatory2_meds_%s.tif', char(spec)));
...
if Link_trial_RT
    ...
    trial_feats = computeTrialPredictors(outputStats, anchors, windows, subj_id_map);
    % columns: subject, condition, trial, N200_a1_rate, N200_a2_rate, P300_a1_rate, P300_a2_rate, LPP_backbone_rate
...
try
    ...
    csvPath = fullfile(outputDir, 'rt_trial_confirmatory2_only_peaks.csv');
end
...
medsT = medsT(sort(ix), :);
    ...
    function T = one_row(s)
        ...
        if ~isfield(s,'med') || isempty(s.med), M = struct();
        else
            M = s.med;
        end
