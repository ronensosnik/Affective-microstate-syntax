...
Generate_performance_table_all_subjects = 0;
Analyze_data_psychophysics = 1;
...
France_subj_BP_II_Depressed = [12 18 24 29 35 36 37 50 53 55 72 77 83 84];
France_subj_BP_II_Euthymic = [7 10 15 33 48 52 56 75 76 80 81 88];
France_subj_HC = [20 23 27 30 39 41 42 44 47 51 57 62 71 73 74];
France_subj_Siblings = [6 9 17 21 22 38 65 66 67 69 78 79 86 87];

Total_num_participants = length([France_subj_BP_I_Depressed France_subj_BP_I_Euthymic France_subj_BP_II_Depressed France_subj_BP_II_Euthymic France_subj_HC France_subj_Siblings]);
...
if check_Dataset
    ...
    disp([num2str(100 - (sum(All_removed_elec == 0) / Total_num_participants) * 100) ' of the datasets required any channel removal']);
    ...
    disp([num2str(100 - (sum(All_removed_ICA_comp == 0) / Total_num_participants) * 100) ' of the datasets required any component removal']);
...
for n = 1: length(France.BP_I.Depressed)
    France_BP_I_Depressed_Neutral_TooEarly(n) = length(find(France.BP_I.Depressed{n}.Neutral.TooEarly == 1)) ;
    France_BP_I_Depressed_Neutral_NoResponse(n) = length(find(France.BP_I.Depressed{n}.Neutral.num_no_resp == 1)) ;
    France_BP_I_Depressed_Neutral_Incorrect(n) = length(find(France.BP_I.Depressed{n}.Neutral.num_Correct_Incorrect_resp == 0)) ;

    France_BP_I_Depressed_Negative_TooEarly(n) = length(find(France.BP_I.Depressed{n}.Negative.TooEarly == 1)) ;
    France_BP_I_Depressed_Negative_NoResponse(n) = length(find(France.BP_I.Depressed{n}.Negative.num_no_resp == 1)) ;
    France_BP_I_Depressed_Negative_Incorrect(n) = length(find(France.BP_I.Depressed{n}.Negative.num_Correct_Incorrect_resp == 0));

    France_BP_I_Depressed_Positive_TooEarly(n) = length(find(France.BP_I.Depressed{n}.Positive.TooEarly == 1)) ;
    France_BP_I_Depressed_Positive_NoResponse(n) = length(find(France.BP_I.Depressed{n}.Positive.num_no_resp == 1)) ;
    France_BP_I_Depressed_Positive_Incorrect(n) = length(find(France.BP_I.Depressed{n}.Positive.num_Correct_Incorrect_resp == 0));
end

for n = 1: length(France.BP_I.Euthymic)
    France_BP_I_Euthymic_Neutral_TooEarly(n) = length(find(France.BP_I.Euthymic{n}.Neutral.TooEarly == 1)) ;
    France_BP_I_Euthymic_Neutral_NoResponse(n) = length(find(France.BP_I.Euthymic{n}.Neutral.num_no_resp == 1)) ;
    France_BP_I_Euthymic_Neutral_Incorrect(n) = length(find(France.BP_I.Euthymic{n}.Neutral.num_Correct_Incorrect_resp == 0)) ;

    France_BP_I_Euthymic_Negative_TooEarly(n) = length(find(France.BP_I.Euthymic{n}.Negative.TooEarly == 1)) ;
    France_BP_I_Euthymic_Negative_NoResponse(n) = length(find(France.BP_I.Euthymic{n}.Negative.num_no_resp == 1)) ;
    France_BP_I_Euthymic_Negative_Incorrect(n) = length(find(France.BP_I.Euthymic{n}.Negative.num_Correct_Incorrect_resp == 0));

    France_BP_I_Euthymic_Positive_TooEarly(n) = length(find(France.BP_I.Euthymic{n}.Positive.TooEarly == 1)) ;
    France_BP_I_Euthymic_Positive_NoResponse(n) = length(find(France.BP_I.Euthymic{n}.Positive.num_no_resp == 1)) ;
    France_BP_I_Euthymic_Positive_Incorrect(n) = length(find(France.BP_I.Euthymic{n}.Positive.num_Correct_Incorrect_resp == 0));
end

for n = 1: length(France.BP_II.Depressed)
    France_BP_II_Depressed_Neutral_TooEarly(n) = length(find(France.BP_II.Depressed{n}.Neutral.TooEarly == 1)) ;
    France_BP_II_Depressed_Neutral_NoResponse(n) = length(find(France.BP_II.Depressed{n}.Neutral.num_no_resp == 1)) ;
    France_BP_II_Depressed_Neutral_Incorrect(n) = length(find(France.BP_II.Depressed{n}.Neutral.num_Correct_Incorrect_resp == 0)) ;

    France_BP_II_Depressed_Negative_TooEarly(n) = length(find(France.BP_II.Depressed{n}.Negative.TooEarly == 1)) ;
    France_BP_II_Depressed_Negative_NoResponse(n) = length(find(France.BP_II.Depressed{n}.Negative.num_no_resp == 1)) ;
    France_BP_II_Depressed_Negative_Incorrect(n) = length(find(France.BP_II.Depressed{n}.Negative.num_Correct_Incorrect_resp == 0));

    France_BP_II_Depressed_Positive_TooEarly(n) = length(find(France.BP_II.Depressed{n}.Positive.TooEarly == 1)) ;
    France_BP_II_Depressed_Positive_NoResponse(n) = length(find(France.BP_II.Depressed{n}.Positive.num_no_resp == 1)) ;
    France_BP_II_Depressed_Positive_Incorrect(n) = length(find(France.BP_II.Depressed{n}.Positive.num_Correct_Incorrect_resp == 0));
end

for n = 1: length(France.BP_II.Euthymic)
    France_BP_II_Euthymic_Neutral_TooEarly(n) = length(find(France.BP_II.Euthymic{n}.Neutral.TooEarly == 1)) ;
    France_BP_II_Euthymic_Neutral_NoResponse(n) = length(find(France.BP_II.Euthymic{n}.Neutral.num_no_resp == 1)) ;
    France_BP_II_Euthymic_Neutral_Incorrect(n) = length(find(France.BP_II.Euthymic{n}.Neutral.num_Correct_Incorrect_resp == 0)) ;

    France_BP_II_Euthymic_Negative_TooEarly(n) = length(find(France.BP_II.Euthymic{n}.Negative.TooEarly == 1)) ;
    France_BP_II_Euthymic_Negative_NoResponse(n) = length(find(France.BP_II.Euthymic{n}.Negative.num_no_resp == 1)) ;
    France_BP_II_Euthymic_Negative_Incorrect(n) = length(find(France.BP_II.Euthymic{n}.Negative.num_Correct_Incorrect_resp == 0));

    France_BP_II_Euthymic_Positive_TooEarly(n) = length(find(France.BP_II.Euthymic{n}.Positive.TooEarly == 1)) ;
    France_BP_II_Euthymic_Positive_NoResponse(n) = length(find(France.BP_II.Euthymic{n}.Positive.num_no_resp == 1)) ;
    France_BP_II_Euthymic_Positive_Incorrect(n) = length(find(France.BP_II.Euthymic{n}.Positive.num_Correct_Incorrect_resp == 0));
end

for n = 1: length(France.HC)
    France_HC_Neutral_TooEarly(n) = length(find(France.HC{n}.Neutral.TooEarly == 1)) ;
    France_HC_Neutral_NoResponse(n) = length(find(France.HC{n}.Neutral.num_no_resp == 1)) ;
    France_HC_Neutral_Incorrect(n) = length(find(France.HC{n}.Neutral.num_Correct_Incorrect_resp == 0)) ;

    France_HC_Negative_TooEarly(n) = length(find(France.HC{n}.Negative.TooEarly == 1)) ;
    France_HC_Negative_NoResponse(n) = length(find(France.HC{n}.Negative.num_no_resp == 1)) ;
    France_HC_Negative_Incorrect(n) = length(find(France.HC{n}.Negative.num_Correct_Incorrect_resp == 0));

    France_HC_Positive_TooEarly(n) = length(find(France.HC{n}.Positive.TooEarly == 1)) ;
    France_HC_Positive_NoResponse(n) = length(find(France.HC{n}.Positive.num_no_resp == 1)) ;
    France_HC_Positive_Incorrect(n) = length(find(France.HC{n}.Positive.num_Correct_Incorrect_resp == 0));
end

for n = 1: length(France.Siblings)
    France_Siblings_Neutral_TooEarly(n) = length(find(France.Siblings{n}.Neutral.TooEarly == 1)) ;
    France_Siblings_Neutral_NoResponse(n) = length(find(France.Siblings{n}.Neutral.num_no_resp == 1)) ;
    France_Siblings_Neutral_Incorrect(n) = length(find(France.Siblings{n}.Neutral.num_Correct_Incorrect_resp == 0)) ;

    France_Siblings_Negative_TooEarly(n) = length(find(France.Siblings{n}.Negative.TooEarly == 1)) ;
    France_Siblings_Negative_NoResponse(n) = length(find(France.Siblings{n}.Negative.num_no_resp == 1)) ;
    France_Siblings_Negative_Incorrect(n) = length(find(France.Siblings{n}.Negative.num_Correct_Incorrect_resp == 0));

    France_Siblings_Positive_TooEarly(n) = length(find(France.Siblings{n}.Positive.TooEarly == 1)) ;
    France_Siblings_Positive_NoResponse(n) = length(find(France.Siblings{n}.Positive.num_no_resp == 1)) ;
    France_Siblings_Positive_Incorrect(n) = length(find(France.Siblings{n}.Positive.num_Correct_Incorrect_resp == 0));
end
...
disp(['BP_I_Depressed_Neutral: No response: ' num2str(mean(France_BP_I_Depressed_Neutral_NoResponse)) ' ' char(177) ' ' num2str(std(France_BP_I_Depressed_Neutral_NoResponse))]);
disp(['BP_I_Depressed_Neutral: Wrong response: ' num2str(mean(France_BP_I_Depressed_Neutral_Incorrect)) ' ' char(177) ' ' num2str(std(France_BP_I_Depressed_Neutral_Incorrect))]);
disp(['BP_I_Depressed_Neutral: Too early: ' num2str(mean(France_BP_I_Depressed_Neutral_TooEarly)) ' ' char(177) ' ' num2str(std(France_BP_I_Depressed_Neutral_TooEarly))]);

disp(' ');

disp(['BP_I_Depressed_Negative: No response: ' num2str(mean(France_BP_I_Depressed_Negative_NoResponse)) ' ' char(177) ' ' num2str(std(France_BP_I_Depressed_Negative_NoResponse))]);
disp(['BP_I_Depressed_Negative: Wrong response: ' num2str(mean(France_BP_I_Depressed_Negative_Incorrect)) ' ' char(177) ' ' num2str(std(France_BP_I_Depressed_Negative_Incorrect))]);
disp(['BP_I_Depressed_Negative: Too early: ' num2str(mean(France_BP_I_Depressed_Negative_TooEarly)) ' ' char(177) ' ' num2str(std(France_BP_I_Depressed_Negative_TooEarly))]);

disp(' ');

disp(['BP_I_Depressed_Positive: No response: ' num2str(mean(France_BP_I_Depressed_Positive_NoResponse)) ' ' char(177) ' ' num2str(std(France_BP_I_Depressed_Positive_NoResponse))]);
disp(['BP_I_Depressed_Positive: Wrong response: ' num2str(mean(France_BP_I_Depressed_Positive_Incorrect)) ' ' char(177) ' ' num2str(std(France_BP_I_Depressed_Positive_Incorrect))]);
disp(['BP_I_Depressed_Positive: Too early: ' num2str(mean(France_BP_I_Depressed_Positive_TooEarly)) ' ' char(177) ' ' num2str(std(France_BP_I_Depressed_Positive_TooEarly))]);
...
disp(['BP_I_Euthymic_Neutral: No response: ' num2str(mean(France_BP_I_Euthymic_Neutral_NoResponse)) ' ' char(177) ' ' num2str(std(France_BP_I_Euthymic_Neutral_NoResponse))]);
disp(['BP_I_Euthymic_Neutral: Wrong response: ' num2str(mean(France_BP_I_Euthymic_Neutral_Incorrect)) ' ' char(177) ' ' num2str(std(France_BP_I_Euthymic_Neutral_Incorrect))]);
disp(['BP_I_Euthymic_Neutral: Too early: ' num2str(mean(France_BP_I_Euthymic_Neutral_TooEarly)) ' ' char(177) ' ' num2str(std(France_BP_I_Euthymic_Neutral_TooEarly))]);

disp(' ');

disp(['BP_I_Euthymic_Negative: No respodisp(' ');nse: ' num2str(mean(France_BP_I_Euthymic_Negative_NoResponse)) ' ' char(177) ' ' num2str(std(France_BP_I_Euthymic_Negative_NoResponse))]);
disp(['BP_I_Euthymic_Negative: Wrong response: ' num2str(mean(France_BP_I_Euthymic_Negative_Incorrect)) ' ' char(177) ' ' num2str(std(France_BP_I_Euthymic_Negative_Incorrect))]);
disp(['BP_I_Euthymic_Negative: Too early: ' num2str(mean(France_BP_I_Euthymic_Negative_TooEarly)) ' ' char(177) ' ' num2str(std(France_BP_I_Euthymic_Negative_TooEarly))]);

disp(' ');

disp(['BP_I_Euthymic_Positive: No response: ' num2str(mean(France_BP_I_Euthymic_Positive_NoResponse)) ' ' char(177) ' ' num2str(std(France_BP_I_Euthymic_Positive_NoResponse))]);
disp(['BP_I_Euthymic_Positive: Wrong response: ' num2str(mean(France_BP_I_Euthymic_Positive_Incorrect)) ' ' char(177) ' ' num2str(std(France_BP_I_Euthymic_Positive_Incorrect))]);
disp(['BP_I_Euthymic_Positive: Too early: ' num2str(mean(France_BP_I_Euthymic_Positive_TooEarly)) ' ' char(177) ' ' num2str(std(France_BP_I_Euthymic_Positive_TooEarly))]);
...
disp(['BP_II_Depressed_Neutral: No response: ' num2str(mean(France_BP_II_Depressed_Neutral_NoResponse)) ' ' char(177) ' ' num2str(std(France_BP_II_Depressed_Neutral_NoResponse))]);
disp(['BP_II_Depressed_Neutral: Wrong response: ' num2str(mean(France_BP_II_Depressed_Neutral_Incorrect)) ' ' char(177) ' ' num2str(std(France_BP_II_Depressed_Neutral_Incorrect))]);
disp(['BP_II_Depressed_Neutral: Too early: ' num2str(mean(France_BP_II_Depressed_Neutral_TooEarly)) ' ' char(177) ' ' num2str(std(France_BP_II_Depressed_Neutral_TooEarly))]);

disp(' ');

disp(['BP_II_Depressed_Negative: No response: ' num2str(mean(France_BP_II_Depressed_Negative_NoResponse)) ' ' char(177) ' ' num2str(std(France_BP_II_Depressed_Negative_NoResponse))]);
disp(['BP_II_Depressed_Negative: Wrong response: ' num2str(mean(France_BP_II_Depressed_Negative_Incorrect)) ' ' char(177) ' ' num2str(std(France_BP_II_Depressed_Negative_Incorrect))]);
disp(['BP_II_Depressed_Negative: Too early: ' num2str(mean(France_BP_II_Depressed_Negative_TooEarly)) ' ' char(177) ' ' num2str(std(France_BP_II_Depressed_Negative_TooEarly))]);

disp(' ');

disp(['BP_II_Depressed_Positive: No response: ' num2str(mean(France_BP_II_Depressed_Positive_NoResponse)) ' ' char(177) ' ' num2str(std(France_BP_II_Depressed_Positive_NoResponse))]);
disp(['BP_II_Depressed_Positive: Wrong response: ' num2str(mean(France_BP_II_Depressed_Positive_Incorrect)) ' ' char(177) ' ' num2str(std(France_BP_II_Depressed_Positive_Incorrect))]);
disp(['BP_II_Depressed_Positive: Too early: ' num2str(mean(France_BP_II_Depressed_Positive_TooEarly)) ' ' char(177) ' ' num2str(std(France_BP_II_Depressed_Positive_TooEarly))]);
...
disp(['BP_II_Euthymic_Neutral: No response: ' num2str(mean(France_BP_II_Euthymic_Neutral_NoResponse)) ' ' char(177) ' ' num2str(std(France_BP_II_Euthymic_Neutral_NoResponse))]);
disp(['BP_II_Euthymic_Neutral: Wrong response: ' num2str(mean(France_BP_II_Euthymic_Neutral_Incorrect)) ' ' char(177) ' ' num2str(std(France_BP_II_Euthymic_Neutral_Incorrect))]);
disp(['BP_II_Euthymic_Neutral: Too early: ' num2str(mean(France_BP_II_Euthymic_Neutral_TooEarly)) ' ' char(177) ' ' num2str(std(France_BP_II_Euthymic_Neutral_TooEarly))]);

disp(' ');

disp(['BP_II_Euthymic_Negative: No respodisp(' ');nse: ' num2str(mean(France_BP_II_Euthymic_Negative_NoResponse)) ' ' char(177) ' ' num2str(std(France_BP_II_Euthymic_Negative_NoResponse))]);
disp(['BP_II_Euthymic_Negative: Wrong response: ' num2str(mean(France_BP_II_Euthymic_Negative_Incorrect)) ' ' char(177) ' ' num2str(std(France_BP_II_Euthymic_Negative_Incorrect))]);
disp(['BP_II_Euthymic_Negative: Too early: ' num2str(mean(France_BP_II_Euthymic_Negative_TooEarly)) ' ' char(177) ' ' num2str(std(France_BP_II_Euthymic_Negative_TooEarly))]);

disp(' ');

disp(['BP_II_Euthymic_Positive: No response: ' num2str(mean(France_BP_II_Euthymic_Positive_NoResponse)) ' ' char(177) ' ' num2str(std(France_BP_II_Euthymic_Positive_NoResponse))]);
disp(['BP_II_Euthymic_Positive: Wrong response: ' num2str(mean(France_BP_II_Euthymic_Positive_Incorrect)) ' ' char(177) ' ' num2str(std(France_BP_II_Euthymic_Positive_Incorrect))]);
disp(['BP_II_Euthymic_Positive: Too early: ' num2str(mean(France_BP_II_Euthymic_Positive_TooEarly)) ' ' char(177) ' ' num2str(std(France_BP_II_Euthymic_Positive_TooEarly))]);
...
disp(['HC_Neutral: No response: ' num2str(mean(France_HC_Neutral_NoResponse)) ' ' char(177) ' ' num2str(std(France_HC_Neutral_NoResponse))]);
disp(['HC_Neutral: Wrong response: ' num2str(mean(France_HC_Neutral_Incorrect)) ' ' char(177) ' ' num2str(std(France_HC_Neutral_Incorrect))]);
disp(['HC_Neutral: Too early: ' num2str(mean(France_HC_Neutral_TooEarly)) ' ' char(177) ' ' num2str(std(France_HC_Neutral_TooEarly))]);

disp(' ');

disp(['HC_Negative: No respodisp(' ');nse: ' num2str(mean(France_HC_Negative_NoResponse)) ' ' char(177) ' ' num2str(std(France_HC_Negative_NoResponse))]);
disp(['HC_Negative: Wrong response: ' num2str(mean(France_HC_Negative_Incorrect)) ' ' char(177) ' ' num2str(std(France_HC_Negative_Incorrect))]);
disp(['HC_Negative: Too early: ' num2str(mean(France_HC_Negative_TooEarly)) ' ' char(177) ' ' num2str(std(France_HC_Negative_TooEarly))]);

disp(' ');

disp(['HC_Positive: No response: ' num2str(mean(France_HC_Positive_NoResponse)) ' ' char(177) ' ' num2str(std(France_HC_Positive_NoResponse))]);
disp(['HC_Positive: Wrong response: ' num2str(mean(France_HC_Positive_Incorrect)) ' ' char(177) ' ' num2str(std(France_HC_Positive_Incorrect))]);
disp(['HC_Positive: Too early: ' num2str(mean(France_HC_Positive_TooEarly)) ' ' char(177) ' ' num2str(std(France_HC_Positive_TooEarly))]);
...
disp(['Siblings_Neutral: No response: ' num2str(mean(France_Siblings_Neutral_NoResponse)) ' ' char(177) ' ' num2str(std(France_Siblings_Neutral_NoResponse))]);
disp(['Siblings_Neutral: Wrong response: ' num2str(mean(France_Siblings_Neutral_Incorrect)) ' ' char(177) ' ' num2str(std(France_Siblings_Neutral_Incorrect))]);
disp(['Siblings_Neutral: Too early: ' num2str(mean(France_Siblings_Neutral_TooEarly)) ' ' char(177) ' ' num2str(std(France_Siblings_Neutral_TooEarly))]);

disp(' ');

disp(['Siblings_Negative: No respodisp(' ');nse: ' num2str(mean(France_Siblings_Negative_NoResponse)) ' ' char(177) ' ' num2str(std(France_Siblings_Negative_NoResponse))]);
disp(['Siblings_Negative: Wrong response: ' num2str(mean(France_Siblings_Negative_Incorrect)) ' ' char(177) ' ' num2str(std(France_Siblings_Negative_Incorrect))]);
disp(['Siblings_Negative: Too early: ' num2str(mean(France_Siblings_Negative_TooEarly)) ' ' char(177) ' ' num2str(std(France_Siblings_Negative_TooEarly))]);

disp(' ');

disp(['Siblings_Positive: No response: ' num2str(mean(France_Siblings_Positive_NoResponse)) ' ' char(177) ' ' num2str(std(France_Siblings_Positive_NoResponse))]);
disp(['Siblings_Positive: Wrong response: ' num2str(mean(France_Siblings_Positive_Incorrect)) ' ' char(177) ' ' num2str(std(France_Siblings_Positive_Incorrect))]);
disp(['Siblings_Positive: Too early: ' num2str(mean(France_Siblings_Positive_TooEarly)) ' ' char(177) ' ' num2str(std(France_Siblings_Positive_TooEarly))]);
