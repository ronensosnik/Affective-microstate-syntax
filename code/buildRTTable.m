...
rt_tbl = table(subj_vec, group_vec, mood_vec, cond_vec, median_rt_ms_vec, log_median_rt_vec, n_used_vec, age_vec, gender_vec, MADRS_vec, YMRS_vec, GAF_vec, ...
    'VariableNames', {'subject', 'group', 'mood', 'condition', 'median_rt_ms', 'log_median_rt', 'n_used', 'age', 'gender', 'MADRS', 'YMRS', 'GAF'});
